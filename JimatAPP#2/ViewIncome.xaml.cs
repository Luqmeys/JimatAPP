namespace JimatAPP_2
{
    public partial class ViewIncome : ContentPage
    {
        ...
        // Called from ViewExpenses Income tab — keeps the same date
        public ViewIncome(DateTime targetDate)
        {
            InitializeComponent();
        ...
        public ViewIncome(DateTime targetDate, bool fromSummary)
        {
            InitializeComponent();
            _currentDate = targetDate.Date;
        }
        ...
        private void RefreshIncomeList()
        {
            ...
            DateLabel.Text         = isToday ? $"Today · {_currentDate:M/d/yyyy}" : _currentDate.ToString("dddd · M/d/yyyy");
